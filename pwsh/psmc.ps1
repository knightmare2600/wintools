...
$menuFile = [Terminal.Gui.MenuBarItem]::new("_File", @(
    [Terminal.Gui.MenuItem]::new("_Theme","Change color theme",[Action]{ Show-ThemeSelector })
    [Terminal.Gui.MenuItem]::new("E_xit (F10)", "Quit", [Action]{ [Terminal.Gui.Application]::RequestStop() })
  ))
